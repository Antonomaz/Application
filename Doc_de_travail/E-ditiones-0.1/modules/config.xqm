...
(:~~
 ...
 :)
declare variable $config:webcomponents :="1.19.0";
...
(:
 ...
 :)
declare variable $config:default-template :="presentation.html";
...
declare variable $config:facets := [
    map {
        ...
        "output": function($label) {
            switch($label)
                case "MSS" return "Manuscrits"
                case "Printed" return "Imprimés"
...
declare variable $config:default-odd :="E-Ditiones.odd";
