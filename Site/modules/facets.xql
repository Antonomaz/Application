    ...
    return
        <div>
            ...
            <i class="bi bi-info-circle-fill">
                <span onclick="javascript : afficher_aide(document.getElementById('Auteurs'))"/>
            </i>
            <div class="infobulle">
                <div class="infobulle-texte" id="Auteurs" style="display: none;">
                    <p>Lorem</p>
                </div>
                <div class="infobulle-texte" id="Imprimeurs" style="display: none;">
                    Lorem
                </div>
            </div> -->
            {
              if (exists($config?max)) then
                    <paper-checkbox class="facet" name="all-{$config?dimension}">
                        ...
                        <pb-i18n>Afficher les 50 premiers</pb-i18n>
                    </paper-checkbox>
                else
                    ()
            }
